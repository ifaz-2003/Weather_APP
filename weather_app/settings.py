...
SECRET_KEY = "django-insecure-b+v%phv^wuizk)261&02ux4_mc0dvfe%^1qxt+h6*ks&%r$+&x"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['weather-app-bmmd.onrender.com', 'localhost','127.0.0.1']
...
# Add this to collect static files on deploy
STATICFILES_DIRS = [
